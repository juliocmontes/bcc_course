...
Description: two different counters, from 0-1 and 0-10 counting them multiple times 
*/
...
//             counter1 += '*';
//         } else if (0.1 <= randnum < 0.2) {
//             counter2 += '*';
//         } else if (0.2 <= randnum < 0.3) {
//             counter3 += '*';
//         } else if (0.3 <= randnum < 0.4) {
//             counter4 += '*';
//         } else if (0.4 <= randnum < 0.5) {
//             counter5 += '*';
//         }  else if (0.5 <= randnum < 0.6) {
//             counter6 += '*';
//         } else if (0.6 <= randnum < 0.7) {
//             counter7 += '*';
//         } else if (0.7 <= randnum < 0.8) {
//             counter8 += '*';
//         }  else if (0.8 <= randnum < 0.9) {
//             counter9 += '*';
//         } else
//             counter10 += '*';
//     };
